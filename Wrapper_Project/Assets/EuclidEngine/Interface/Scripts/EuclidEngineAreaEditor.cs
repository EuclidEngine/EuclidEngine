...
[CustomEditor(typeof(EuclidEngineArea))]
[CanEditMultipleObjects]
[InitializeOnLoad]
public class EuclidEngineAreaEditor : Editor
{
    ...
    {
        var obj = EuclidEngineArea.Instantiate(areaSize, internalSize, position, rotation);
    ...
    {
        var obj = EuclidEngineArea.Instantiate(Vector3.one, Vector3.one, Vector3.one, Quaternion.identity);
        obj.gameObject.name = "New EuclidEngineArea";
    }
