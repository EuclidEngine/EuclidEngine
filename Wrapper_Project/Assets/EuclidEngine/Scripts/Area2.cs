...
namespace EuclidEngine
{
    ...
    public class Area2 : MonoBehaviour
    {
        ...
        [DllImport(EuclidEngineDll.plugin)] protected static extern void EEAreaSetCameraPosition(IntPtr area, Vector3 position);
        ...
        [DllImport(EuclidEngineDll.plugin)] protected static extern void EEAreaGetTransformMatrix(IntPtr area, Vector3 dir, out Matrix4x4 ret);
        [DllImport(EuclidEngineDll.plugin)] protected static extern void EEAreaUpdate(IntPtr area);
        ...
        protected AreaPlane _planeRight;
        protected AreaPlane _planeLeft;
        protected AreaPlane _planeTop;
        protected AreaPlane _planeBottom;
        protected AreaPlane _planeFront;
        protected AreaPlane _planeBack;

        // Used later to sort all plane by they distance with the camera
        protected List<KeyValuePair<AreaPlane, Vector3>> _sortAreaPlane = new List<KeyValuePair<AreaPlane, Vector3>>();
        ...
        protected virtual void Start()
        {
            ...
            _camera = Instantiate(new GameObject(), transform).AddComponent<UnityEngine.Camera>();
            ...
            //set sortAreaPlane
            _sortAreaPlane.Add(new KeyValuePair<AreaPlane, Vector3>(_planeBack, transform.forward));
            _sortAreaPlane.Add(new KeyValuePair<AreaPlane, Vector3>(_planeFront, -transform.forward));
            _sortAreaPlane.Add(new KeyValuePair<AreaPlane, Vector3>(_planeRight, -transform.right));
            _sortAreaPlane.Add(new KeyValuePair<AreaPlane, Vector3>(_planeLeft, transform.right));
            _sortAreaPlane.Add(new KeyValuePair<AreaPlane, Vector3>(_planeTop, -transform.up));
            _sortAreaPlane.Add(new KeyValuePair<AreaPlane, Vector3>(_planeBottom, transform.up));
        }
        ...
        void OnTriggerEnter(Collider c)
        {
            ...
            c.gameObject.AddComponent<EEObject>();
        }
        ...
        void OnTriggerExit(Collider c)
        {
            ...
            Destroy(c.gameObject.GetComponent<EEObject>());
        }
        ...
        /// @param parent The parent of the new EuclidEngineArea
        /// @return A new EuclidEngineArea attached on a new GameObject
        public static Area2 Instantiate(Vector3 areaSize, Vector3 internalSize, Vector3 transitionSize, Vector3 position, Quaternion rotation, Transform parent)
        {
            ...
            Area2 area = go.AddComponent<Area2>();
            area.Reset();
