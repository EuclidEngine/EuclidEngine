...
namespace EuclidEngine
{
    ...
    [System.Serializable]
    public class NonVisualEuclidianRoom2 : Area2
    {
        ...
        private void changeY(int new_y)
        {
            Y = new_y;
        ...
        /* Check Array */
        private List<ListableClass2> BackSide = new List<ListableClass2>(6);
        private List<ListableClass2> FrontSide = new List<ListableClass2>(6);
        private List<ListableClass2> LeftSide = new List<ListableClass2>(6);
        private List<ListableClass2> RightSide = new List<ListableClass2>(6);
        private List<ListableClass2> TopSide = new List<ListableClass2>(6);
        private List<ListableClass2> BottomSide = new List<ListableClass2>(6);

        private List<ListableClass2>[] walls;
        ...
        {
            walls = new List<ListableClass2>[6] { BackSide, FrontSide, LeftSide, RightSide, TopSide, BottomSide };
        ...
        protected new void Start()
        {
            ...
            //transform.position = Vector3.MoveTowards(transform.position, t, 1);
        }

        private void ChangeWallsMaterial(int _NumberOfPieces, ref bool[] good_faces, ref List<ListableClass2>[] walls)
        {
            int k = 0;

            /*
             * Modify ArrayOfSides here
            */
            ArrayOfSides[2][1, 0] = true;
            ArrayOfSides[2][1, 1] = true;
            ArrayOfSides[2][1, 2] = true;
            ArrayOfSides[2][1, 3] = true;
            ArrayOfSides[2][1, 4] = true;
            ArrayOfSides[2][2, 0] = true;
            ArrayOfSides[2][2, 1] = true;
            ArrayOfSides[2][2, 2] = true;
            ArrayOfSides[2][2, 3] = true;
            ArrayOfSides[2][2, 4] = true;

            ArrayOfSides[1][1, 0] = true;
            ArrayOfSides[1][1, 1] = true;
            ArrayOfSides[1][1, 2] = true;
            ArrayOfSides[1][1, 3] = true;
            ArrayOfSides[1][1, 4] = true;
            ArrayOfSides[1][2, 0] = true;
            ArrayOfSides[1][2, 1] = true;
            ArrayOfSides[1][2, 2] = true;
            ArrayOfSides[1][2, 3] = true;
            ArrayOfSides[1][2, 4] = true;
