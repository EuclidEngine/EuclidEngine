...
namespace EuclidEngine
{
    ...
    [System.Serializable]
    public class NonVisualEuclidianRoom : Area2
    {
        ...
        /* Check Array */
        private List<ListableClass1> BackSide = new List<ListableClass1>(6);
        private List<ListableClass1> FrontSide = new List<ListableClass1>(6);
        private List<ListableClass1> LeftSide = new List<ListableClass1>(6);
        private List<ListableClass1> RightSide = new List<ListableClass1>(6);
        private List<ListableClass1> TopSide = new List<ListableClass1>(6);
        private List<ListableClass1> BottomSide = new List<ListableClass1>(6);

        private List<ListableClass1>[] walls;
        ...
        {
            walls = new List<ListableClass1>[6] { BackSide, FrontSide, LeftSide, RightSide, TopSide, BottomSide };
        ...
        private void ChangeWallsMaterial(int _NumberOfPieces, ref bool[] good_faces, ref List<ListableClass1>[] walls)
        {
            int k = 0;
